...
Route::get('pesan_tiket/{id_p}/{id_b}',[HomeController::class, 'pesan'] )->middleware(['auth', 'verified'])->name('request_order');
...
Route::get('/send-email', function () {
    Mail::to('triadi.aprillianto@gmail.com')->send(new WelcomeMail());
